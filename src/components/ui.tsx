...
export function ErrorState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-32 gap-4">
      <p className="text-rose text-sm bg-rose/10 border border-rose/20 rounded-xl px-4 py-2">
        {message}
      </p>
...
export function GlowCard({
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLElement).style.boxShadow = `0 12px 40px -10px rgba(${glowColor},0.35)`;
      }}
      onMouseLeave={(e) => {
